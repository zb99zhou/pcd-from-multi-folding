...
pub trait ExtendFunc<Scalar: PrimeField>{
    ...
    fn add<CS: ConstraintSystem<Scalar>>(&self, cs: CS, other: &AllocatedNum<Scalar>) -> Result<AllocatedNum<Scalar>, SynthesisError>;

    fn sub_constant<CS: ConstraintSystem<Scalar>>(&self, cs: CS, constant: Scalar) -> Result<AllocatedNum<Scalar>, SynthesisError>;
    ...
    fn invert_with_scale<CS: ConstraintSystem<Scalar>>(&self, cs: CS, scale: Scalar) -> Result<AllocatedNum<Scalar>, SynthesisError>;
}

impl<Scalar: PrimeField> ExtendFunc<Scalar> for AllocatedNum<Scalar> {
    fn zero<CS: ConstraintSystem<Scalar>>(mut cs: CS) -> Result<AllocatedNum<Scalar>, SynthesisError> {
    ...
    fn add<CS: ConstraintSystem<Scalar>>(&self, mut cs: CS, other: &AllocatedNum<Scalar>) -> Result<AllocatedNum<Scalar>, SynthesisError> {
        let tmp = AllocatedNum::alloc(
            cs.namespace(|| "alloc tmp"),
            || self.get_value()
    ...
    fn sub_constant<CS: ConstraintSystem<Scalar>>(&self, mut cs: CS, constant: Scalar) -> Result<AllocatedNum<Scalar>, SynthesisError> {
        let tmp = AllocatedNum::alloc(
            cs.namespace(|| "alloc tmp"),
            || self.get_value()
                .map(|v| v - constant)
    ...
    fn pow_constant<CS: ConstraintSystem<Scalar>>(&self, mut cs: CS, constant: usize) -> Result<AllocatedNum<Scalar>, SynthesisError> {
        let mut res = AllocatedNum::alloc(
            cs.namespace(|| "one"),
            || Ok(Scalar::ONE)
        )?;
    ...
    fn invert_with_scale<CS: ConstraintSystem<Scalar>>(&self, mut cs: CS, scale: Scalar) -> Result<AllocatedNum<Scalar>, SynthesisError> {
