...
mod test {
    ...
    fn test_mat_vec_mul() -> () {
        let A = vec![
            vec![bn256::Scalar::from(2u64), bn256::Scalar::from(3u64), bn256::Scalar::from(4u64)],
            vec![bn256::Scalar::from(4u64), bn256::Scalar::from(11u64), bn256::Scalar::from(14u64)],
            vec![bn256::Scalar::from(2u64), bn256::Scalar::from(8u64), bn256::Scalar::from(17u64)],
        ];
        ...
        assert_eq!(
            ...
            vec![bn256::Scalar::from(806u64), bn256::Scalar::from(2762u64), bn256::Scalar::from(2656u64)]
        );
    }
}
